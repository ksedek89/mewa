package com.pru.starter.config.filter;
...
public class RequestAndResponseLoggingFilter extends OncePerRequestFilter {
    ...
    private static void logContent(byte[] content, String contentType, String contentEncoding, String prefix) {
        val visible = VISIBLE_TYPES.stream().anyMatch(visibleType -> visibleType.includes(StringUtils.isNotEmpty(contentType) ?
            MediaType.valueOf(contentType) : null));
        if (visible) {
            try {
